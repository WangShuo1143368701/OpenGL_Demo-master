...
***/
package com.roger.skybox.wallpaper;
...
import com.roger.skybox.ParticlesRenderer;
import com.roger.skybox.util.LoggerConfig;
    ...
    public class GLEngine extends Engine {
        ...
        public void onOffsetsChanged(final float xOffset, final float yOffset,
           ...
           glSurfaceView.queueEvent(new Runnable() {
                @Override
                public void run() {
                    particlesRenderer.handleTouchDrag(xOffset, yOffset);
                }
            });
        }
        @Override
