...
public class ParticlesRenderer implements GLSurfaceView.Renderer {
  ...
  @Override public void onDrawFrame(GL10 gl10) {
    GLES20.glClear(GLES20.GL_COLOR_BUFFER_BIT | GLES20.GL_DEPTH_BUFFER_BIT);//在每个新帧上也要清空深度缓冲区
    drawHeightmap();
    drawSkybox();
    drawParticles();
  }
  ...
  private void drawSkybox() {
    ...
    glDepthFunc(GL_LEQUAL); // This avoids problems with the skybox itself getting clipped.//深度测试算法
